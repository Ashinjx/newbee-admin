    ...
    <el-card class="box-card">
      ...
      <template #header>
        <div class="card-header">
          <el-button type="primary" size="small" icon="el-icon-plus" @click="addHotSale">增加</el-button>
          <el-popconfirm title="确定删除吗？" @confirm="deleteHotSale(...multipleSelection)">
            <template #reference>
    ...
    <el-dialog :title="type == 'add' ? '添加商品' : '修改商品'" :visible="visible" width="400px">
      <el-form :model="hotSaleForm" :rules="rules" label-width="100px" ref="hotSaleForm" class="good-form">
        ...
        <el-form-item label="排序值" prop="sortValue">
          <el-input type="number" v-model="hotSaleForm.sortValue"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="visible = false" class="off">取 消</el-button>
          <el-button type="primary" @click="send('hotSaleForm')">确 定</el-button>
        </span>
      </template>
    </el-dialog>
  </div>
